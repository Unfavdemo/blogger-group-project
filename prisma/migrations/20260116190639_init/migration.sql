...
-- CreateIndex
CREATE INDEX "wellness_userId_idx" ON "wellness"("userId");

-- CreateIndex
CREATE INDEX "wellness_createdAt_idx" ON "wellness"("createdAt");
...
-- AddForeignKey
ALTER TABLE "wellness" ADD CONSTRAINT "wellness_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
